...
namespace winrt::tcalc::implementation
{
    ...
    public:
        ...
        void help_link_fp_functions_Click(winrt::Windows::UI::Xaml::Documents::Hyperlink const& sender, winrt::Windows::UI::Xaml::Documents::HyperlinkClickEventArgs const& args);
